...
{
       0,     0,     3,    10,    14,    19,    21,    23,    25,    28,
      30,    32,    37,    39,    43,    47,    51,    55,    61,    67,
      69
};
...
{
      37,     0,    -1,     3,    38,     5,    40,     6,     4,    -1,
      39,    34,    28,    -1,    39,    34,    28,    38,    -1,     7,
      -1,     8,    -1,    41,    -1,    41,    40,    -1,    42,    -1,
      44,    -1,    34,    22,    43,    28,    -1,    45,    -1,    45,
      23,    45,    -1,    45,    24,    45,    -1,    45,    25,    45,
      -1,    45,    26,    45,    -1,    12,    30,    34,    31,    28,
      -1,    11,    30,    45,    31,    28,    -1,    34,    -1,    35,
      -1
};
...
static const yytype_uint8 yyrline[] =
{
     ...
     121,   124,   136,   137,   153,   168,   183,   200,   207,   216,
     221
};
#endif
...
static const char *const yytname[] =
{
  ...
  "BEGIN_BLOCK", "END_BLOCK", "INT", "REAL", "ARRAY_INT", "ARRAY_REAL",
  "READ", "WRITE", "IF", "ELSE", "WHILE", "NE", "GT", "LT", "EQ", "GE",
  "LE", "ASSUME", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "AND",
  "SEMICOLON", "COMMA", "LEFT_BRACKET", "RIGHT_BRACKET",
  "SQUARE_LEFT_BRACKET", "SQUARE_RIGHT_BRACKET", "ID", "CONST", "$accept",
  "program", "lista_declaratii", "tip", "lista_instr", "instr",
  "instr_atribuire", "expresie", "instr_io", "termen", YY_NULL
};
#endif
...
{
       0,     0,     0,     5,     6,     0,     0,     1,     0,     0,
       0,     0,     0,     0,     7,     9,    10,     3,     0,     0,
       0,     0,     8,     4,    19,    20,     0,     0,     0,    12,
       2,     0,     0,    11,     0,     0,     0,     0,    18,    17,
      13,    14,    15,    16
};
...
{
       8,     0,    12,   -26,   -26,     9,   -21,   -26,   -11,   -13,
     -10,    -9,     2,    16,   -11,   -26,   -26,     0,   -25,    -8,
     -25,    21,   -26,   -26,   -26,   -26,    -4,    -3,     1,   -20,
     -26,     3,     4,   -26,   -25,   -25,   -25,   -25,   -26,   -26,
     -26,   -26,   -26,   -26
};
...
{
      10,    11,    29,    34,    35,    36,    37,     3,     4,    24,
      25,     1,     7,     9,     8,    17,    40,    41,    42,    43,
      18,    19,    21,    12,    20,    30,    27,    31,    32,    33,
      23,    38,    39,    22
};
...
{
      11,    12,    20,    23,    24,    25,    26,     7,     8,    34,
      35,     3,     0,    34,     5,    28,    34,    35,    36,    37,
      30,    30,     6,    34,    22,     4,    34,    31,    31,    28,
      17,    28,    28,    14
};
...
{
       0,     3,    37,     7,     8,    38,    39,     0,     5,    34,
      11,    12,    34,    40,    41,    42,    44,    28,    30,    30,
      22,     6,    40,    38,    34,    35,    45,    34,    43,    45,
       4,    31,    31,    28,    23,    24,    25,    26,    28,    28,
      45,    45,    45,    45
};
...
#line 201 "bison.y"
    {
		char *tmp = (char *)malloc(sizeof(char)*100);
		addTempToCS(moveVarToPrintBuffer((yyvsp[(3) - (5)].varname)));
